...
void Mat4::multiply(const Mat4& o, float t[16]) const
{
  ...
  t[2] =
    (e[0] * o.e[2]) + (e[1] * o.e[6]) + (e[2] * o.e[10]) + (e[3] * o.e[14]);
  t[3] =
    (e[0] * o.e[3]) + (e[1] * o.e[7]) + (e[2] * o.e[11]) + (e[3] * o.e[15]);

  t[4] = (e[4] * o.e[0]) + (e[5] * o.e[4]) + (e[6] * o.e[8]) + (e[7] * o.e[12]);
  t[5] = (e[4] * o.e[1]) + (e[5] * o.e[5]) + (e[6] * o.e[9]) + (e[7] * o.e[13]);
  t[6] =
    (e[4] * o.e[2]) + (e[5] * o.e[6]) + (e[6] * o.e[10]) + (e[7] * o.e[14]);
  t[7] =
    (e[4] * o.e[3]) + (e[5] * o.e[7]) + (e[6] * o.e[11]) + (e[7] * o.e[15]);

  t[8] =
    (e[8] * o.e[0]) + (e[9] * o.e[4]) + (e[10] * o.e[8]) + (e[11] * o.e[12]);
  t[9] =
    (e[8] * o.e[1]) + (e[9] * o.e[5]) + (e[10] * o.e[9]) + (e[11] * o.e[13]);
  t[10] =
    (e[8] * o.e[2]) + (e[9] * o.e[6]) + (e[10] * o.e[10]) + (e[11] * o.e[14]);
  t[11] =
    (e[8] * o.e[3]) + (e[9] * o.e[7]) + (e[10] * o.e[11]) + (e[11] * o.e[15]);

  t[12] =
    (e[12] * o.e[0]) + (e[13] * o.e[4]) + (e[14] * o.e[8]) + (e[15] * o.e[12]);
  t[13] =
    (e[12] * o.e[1]) + (e[13] * o.e[5]) + (e[14] * o.e[9]) + (e[15] * o.e[13]);
  t[14] =
    (e[12] * o.e[2]) + (e[13] * o.e[6]) + (e[14] * o.e[10]) + (e[15] * o.e[14]);
  t[15] =
    (e[12] * o.e[3]) + (e[13] * o.e[7]) + (e[14] * o.e[11]) + (e[15] * o.e[15]);
}
